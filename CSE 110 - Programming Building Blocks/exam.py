...
with open("stock-price.csv") as stock_price_file:
    ...
    print(f"Marty McFly bought 100 shares for ${lowPrice * 100:.2f} and made ${highPrice * 100:.2f} when he sold 100 shares.\n")
